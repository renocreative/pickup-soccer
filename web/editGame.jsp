...
<div class="post">
    ...
    <h1 class="title">Edit a Game</h1>
    <p>&nbsp;</p>
    <form action="/PickupSoccerApplication/game/updateGame" method="POST">

        <div style="font-size:12px;text-align:center;width:600px"><table cellpadding="2" cellspacing="2">
                <input type="hidden" name="gameId" value="${ requestScope.game.gameId }" />
                <tr><td>Date: </td><td>
                        <select name="day">
                ...
                <tr><td></td><td align="right"><input type="submit" name="submit" value="update" /></td><td></td></tr>
            </table></div>
    </form>
